...
class ForecastsControllerTest < ActionController::TestCase
  ...
  test "should create forecast" do
    assert_difference('Forecast.count') do
      post :create, forecast: { attitude: @forecast.attitude, logtitude: @forecast.logtitude, summary: @forecast.summary, temperature: @forecast.temperature }
    end
  ...
  test "should update forecast" do
    patch :update, id: @forecast, forecast: { attitude: @forecast.attitude, logtitude: @forecast.logtitude, summary: @forecast.summary, temperature: @forecast.temperature }
    assert_redirected_to forecast_path(assigns(:forecast))
  end
